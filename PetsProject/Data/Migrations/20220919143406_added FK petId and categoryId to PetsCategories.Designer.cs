...
namespace PetsProject.Data.Migrations
{
    ...
    [Migration("20220919143406_added FK petId and categoryId to PetsCategories")]
    partial class addedFKpetIdandcategoryIdtoPetsCategories
    {
            ...
            modelBuilder.Entity("PetsProject.Models.PetsCategories", b =>
                {
                    ...
                    b.HasOne("PetsProject.Models.Pets", "Pets")
                        .WithMany()
                        .HasForeignKey("PetId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
